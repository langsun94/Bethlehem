...
#1.9.0
path <- "/Volumes/efs/CANR/Ansci/D\'Amico\ Lab/Langsun_las17015/2.\ Bethlehem\ project/Bethlehem2020/Fungi/fastq"
...
## --------------------------------------------------------------------
taxa <- assignTaxonomy(seqtab.nochim,"/Volumes/efs/CANR/Ansci/D\'Amico\ Lab/Langsun_las17015/Fungi\ reference/sh_general_release_dynamic_01.12.2017.fasta")
...
taxa1<-taxa[taxa$Kingdom %in% "k__Fungi",]

#save taxa4 with exact sequences
taxa2<-as.matrix(taxa1)
save(taxa2, file = "taxa.sequence.RData")

## --------------------------------------------------------------------
#import metadata
samdf=read.table("/Volumes/efs/CANR/Ansci/D\'Amico\ Lab/Langsun_las17015/2.\ Bethlehem\ project/Bethlehem2020/Fungi/metadata.txt",header = T)
